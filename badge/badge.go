// Package badge generates Shields.io-compatible SVG status badges for FuSaOps aggregate reports.
package badge
...
func svg(label, message, color string) string {
  ...
  <g fill="#fff" text-anchor="middle" font-family="DejaVu Sans,Verdana,Geneva,sans-serif" font-size="11">
    <text x="35" y="15" fill="#010101" fill-opacity=".3">%s</text>
    <text x="35" y="14">%s</text>
