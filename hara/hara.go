...
func DetermineASIL(s Severity, e Exposure, c Controllability) ASIL {
	...
	table := map[key]ASIL{
		...
		{SeverityS2, ExposureE2, ControllabilityC2}: ASILQM,
		{SeverityS2, ExposureE2, ControllabilityC3}: ASILA,
		{SeverityS2, ExposureE3, ControllabilityC0}: ASILQM,
		{SeverityS2, ExposureE3, ControllabilityC1}: ASILQM,
		{SeverityS2, ExposureE3, ControllabilityC2}: ASILA,
		{SeverityS2, ExposureE3, ControllabilityC3}: ASILB,
		{SeverityS2, ExposureE4, ControllabilityC0}: ASILQM,
		{SeverityS2, ExposureE4, ControllabilityC1}: ASILA,
		{SeverityS2, ExposureE4, ControllabilityC2}: ASILB,
		{SeverityS2, ExposureE4, ControllabilityC3}: ASILC,
		// S3
		{SeverityS3, ExposureE1, ControllabilityC0}: ASILQM,
		{SeverityS3, ExposureE1, ControllabilityC1}: ASILQM,
		{SeverityS3, ExposureE1, ControllabilityC2}: ASILQM,
		{SeverityS3, ExposureE1, ControllabilityC3}: ASILA,
		{SeverityS3, ExposureE2, ControllabilityC0}: ASILQM,
		{SeverityS3, ExposureE2, ControllabilityC1}: ASILQM,
		{SeverityS3, ExposureE2, ControllabilityC2}: ASILA,
		{SeverityS3, ExposureE2, ControllabilityC3}: ASILB,
		{SeverityS3, ExposureE3, ControllabilityC0}: ASILQM,
		{SeverityS3, ExposureE3, ControllabilityC1}: ASILA,
		{SeverityS3, ExposureE3, ControllabilityC2}: ASILB,
		{SeverityS3, ExposureE3, ControllabilityC3}: ASILC,
		{SeverityS3, ExposureE4, ControllabilityC0}: ASILQM,
		{SeverityS3, ExposureE4, ControllabilityC1}: ASILB,
		{SeverityS3, ExposureE4, ControllabilityC2}: ASILC,
