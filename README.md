...
**Bundled tools.** The image currently bundles `gofusa` (Go, v0.32.0). All six
adapters are registered; the other tools' Docker images will be added to the
bundle as they publish to GHCR (cpp-FuSa v0.13.0, c-FuSa v0.5.35, rust-FuSa v0.3.0,
py-FuSa v0.2.0, java-FuSa v0.4.0 are each spec v1.10 aligned). The java-FuSa
...
|----------|------------|----------|------------------|
| Go       | go-FuSa    | `gofusa` | ✅ (v0.32.0, spec v1.10) |
| C++      | cpp-FuSa   | `cpfusa` | ✅ (v0.13.0, spec v1.10) |
| C        | c-FuSa     | `cfusa`  | ✅ (v0.5.35, spec v1.10) |
| Rust     | rust-FuSa  | `rsfusa` | ✅ (v0.3.0, spec v1.10) |
| Python   | py-FuSa    | `pyfusa` | ✅ (v0.2.0, spec v1.10, alpha) |
| Java     | java-FuSa  | `jfusa`  | ✅ (v0.4.0, spec v1.10, alpha) |
